...
class ImageGenerator:
    ...
    def generate_art_prompt(self) -> str:
        ...
        subject_examples = {
            ...
            "Spring": "cherry blossoms, tulips, spring gardens, spring bouquets, wild flowers, spring flowers in a vase, fields of daffodils or bluebells, spring vines and climbing flowers (like clematis or honeysuckle)",
